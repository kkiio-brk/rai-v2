...
<qgis version="3.22.3-Bia?owie?a">
  <identifier>new_county_bdys_KNSDI_M</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>new_county_bdys_KNSDI_M</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" size="" type="Local Area Network" description="" mimeType="" name="" url="file://"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial dimensions="2" maxx="0" crs="EPSG:4326" minz="0" miny="0" maxy="0" minx="0" maxz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
